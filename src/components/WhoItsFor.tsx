...
// ── Data ─────────────────────────────────────────────────────────────────────
const CARDS = [
  { title: 'IT Server Rooms',      badge: 'Enterprise',   stat: '50ft',  sub: 'Rack to rack runs',      bg: '#1C2128', icon: <ServerIcon />,     image: '/IT.jpeg' },
  { title: 'Conference Rooms',     badge: 'AV Install',   stat: '1Gbps', sub: 'Zero trip hazards',      bg: '#1A2E1A', icon: <ConferenceIcon />, image: '/Conference.jpeg' },
  ...
  { title: 'Home Office',          badge: 'Remote Work',  stat: 'Flat',  sub: 'Clean desk setups',      bg: '#1E1428', icon: <HomeOfficeIcon />, image: '/House.jpeg' },
]
